            ...
            <div className="relative w-full max-w-5xl h-[85vh] bg-[#1C2026] border border-white/[0.08] shadow-2xl rounded-2xl flex flex-col overflow-hidden animate-modal-scale-in z-10">
                ...
                <div className="flex items-center justify-between px-8 py-5 border-b border-white/[0.04] bg-[#13161B]/50 select-none">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="text-title text-white uppercase tracking-wider">Help & Learning Center</h2>
                            <span className="text-label text-muted-foreground">Interactive Guides and Concepts Directory</span>
                        </div>
                    </div>
                    <button
                ...
                <div className="flex flex-1 overflow-hidden">
                    ...
                    <div className="w-72 border-r border-white/[0.04] bg-[#13161B]/30 p-6 flex flex-col justify-between select-none">
                        <div className="space-y-1.5">
                            <span className="text-label text-zinc-500 block mb-3 px-2">Learning Directory</span>
                            {tabs.map((tab) => (
                                <button
                                    key={tab.id}
                                    onClick={() => setActiveTab(tab.id)}
                                    className={`w-full flex items-center gap-3 px-4 py-3 text-label rounded-xl border transition-all cursor-pointer ${
                                        activeTab === tab.id
                        ...
                        <div className="space-y-2">
                            ...
                            <button
                                onClick={() => setShowHelpMenu(false)}
                                className="w-full inline-flex h-9 items-center justify-center rounded-xl border border-white/[0.08] bg-white/[0.02] hover:bg-white/[0.08] text-slate-300 hover:text-white text-label transition-all duration-200 cursor-pointer active:scale-95"
                            >
                                Close Help Center
                            </button>
                        </div>
                        ...
                        <div className="space-y-6 max-w-3xl">
                            ...
                            {activeTab === 'quickstart' && (
                                <div className="space-y-6 animate-fade-in">
                                    <div>
                                        <h3 className="text-title text-white uppercase tracking-wide">Welcome to AgentEval!</h3>
                                        <p className="text-body text-slate-300 mt-2 max-w-[75ch]">
                                    ...
                                    <div className="space-y-3.5">
                                        <h4 className="text-label text-[#4A72FF] select-none">Recommended Evaluation Pipeline</h4>
                                        ...
                                        <div className="flex gap-4 p-4 rounded-xl border border-white/[0.04] bg-[#1C2026] shadow-sm select-none">
                                            ...
                                            <div>
                                                <h5 className="text-body font-bold text-white uppercase tracking-wider">Configure API Keys</h5>
                                                <p className="text-body text-slate-400 mt-1 max-w-[75ch]">Enter your Gemini API key in the main system settings. This key powers the LLM evaluator that acts as the user during test simulations.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-4 p-4 rounded-xl border border-white/[0.04] bg-[#1C2026] shadow-sm select-none">
                                            ...
                                            <div>
                                                <h5 className="text-body font-bold text-white uppercase tracking-wider">Define a Project Workspace</h5>
                                                <p className="text-body text-slate-400 mt-1 max-w-[75ch]">Create a project to house your agent\'s system prompt variations, target environments (server URLs), and global documentation.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-4 p-4 rounded-xl border border-white/[0.04] bg-[#1C2026] shadow-sm select-none">
                                            ...
                                            <div>
                                                <h5 className="text-body font-bold text-white uppercase tracking-wider">Model a Test Mission</h5>
                                                <p className="text-body text-slate-400 mt-1 max-w-[75ch]">Formulate the user persona, target goals, scenario variable grids, and strict evaluation checklists for your agents.</p>
                                            </div>
                                        </div>
                                        ...
                                        <div className="flex gap-4 p-4 rounded-xl border border-white/[0.04] bg-[#1C2026] shadow-sm select-none">
                                            ...
                                            <div>
                                                <h5 className="text-body font-bold text-white uppercase tracking-wider">Run Executions & Inspect Logs</h5>
                                                <p className="text-body text-slate-400 mt-1 max-w-[75ch]">Watch the evaluation chat run in real time. Inspect conversational transcripts, API response payloads, and score reports upon completion.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            {activeTab === 'concepts' && (
                                <div className="space-y-4 animate-fade-in">
                                    <h3 className="text-title text-white uppercase tracking-wide mb-2 select-none">Sandbox Architecture Directory</h3>
                                    
                                    <div className="p-5 rounded-xl border border-white/[0.04] bg-[#1C2026] space-y-2 select-none">
                                        <div className="flex items-center gap-2.5 text-body font-bold text-white uppercase tracking-wider">
                                            <FolderOpen className="w-4 h-4 text-[#4A72FF]" />
                                            Projects Container
                                        </div>
                                        <p className="text-body text-slate-400 max-w-[75ch]">
                            ...
                            {activeTab === 'tips' && (
                                <div className="space-y-6 animate-fade-in text-slate-300">
                                    <div>
                                        <h3 className="text-title text-white uppercase tracking-wide select-none">Test Modeling & Dynamic Variables</h3>
                                        <p className="text-body text-slate-400 mt-2 max-w-[75ch]">
                                            To create robust, reusable agent evaluations without hardcoding static values, utilize dynamic variables.
                                        </p>
                                    </div>
 
                                    <div className="space-y-4">
                                        <h4 className="text-label text-[#4A72FF] select-none">Double Curly Braces Variable Syntax</h4>
                                        <p className="text-body text-slate-400 max-w-[75ch]">
                                        ...
                                        <h4 className="text-label text-purple-400 select-none">Writing Acceptance Criteria Checklist</h4>
                                        <div className="p-4 bg-[#1C2026] border border-white/[0.04] rounded-xl space-y-2 select-none">
                                            <span className="text-label text-[#4A72FF] block">Criteria Best Practices</span>
                                            <p className="text-body text-slate-400">
                                                Write explicit, concrete evaluation metrics. Avoid generic statements:
                                            </p>
                                            <ul className="text-body space-y-1.5 list-disc list-inside text-slate-300">
                            ...
                            {activeTab === 'faq' && (
                                <div className="space-y-5 animate-fade-in">
                                    <h3 className="text-title text-white uppercase tracking-wide select-none">Frequently Asked Questions</h3>
                                    
                                    <div className="border-b border-white/[0.04] pb-4 space-y-1.5 select-none">
                                        <h4 className="text-body font-bold text-white flex items-center gap-1.5 uppercase tracking-wide">
                                            <ChevronRight className="w-4 h-4 text-[#4A72FF]" />
                                            Why do I need a Gemini API Key?
                                        </h4>
                                        <p className="text-body text-slate-400 pl-5 max-w-[75ch]">
                                    ...
                                    <div className="border-b border-white/[0.04] pb-4 space-y-1.5 select-none">
                                        ...
                                        <p className="text-body text-slate-400 pl-5 font-mono max-w-[75ch]">
                            ...
                            {activeTab === 'tours' && (
                                <div className="space-y-5 animate-fade-in select-none">
                                    <div>
                                        <h3 className="text-title text-white uppercase tracking-wide">Interactive Onboarding Tutorials</h3>
                                        <p className="text-body text-slate-400 mt-2 max-w-[75ch]">
                                    ...
                                    <div className="grid grid-cols-1 gap-4 pt-2">
                                        ...
                                        <div className="p-5 bg-[#1C2026] border border-white/[0.04] rounded-xl flex items-center justify-between gap-4">
                                            <div className="space-y-1">
                                                <h4 className="text-body font-bold text-white uppercase tracking-wider flex items-center gap-2">
                                                    <span className="w-2 h-2 rounded-full bg-emerald-500" />
                                                    General Dashboard Guide
                                                </h4>
                                                <p className="text-body text-slate-400 max-w-[75ch]">Learn about the main workspace screen, active project lists, global test history logs, and settings.</p>
                                            </div>
                                            <button 
                                                onClick={handleStartGeneralTour}
                                                className="px-4 py-2 bg-[#4A72FF] hover:bg-[#3B5DD8] text-white text-label rounded-lg transition-colors flex items-center gap-1 cursor-pointer whitespace-nowrap"
                                            >
                                        ...
                                        <div className="p-5 bg-[#1C2026] border border-white/[0.04] rounded-xl flex items-center justify-between gap-4">
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-body text-slate-400 max-w-[75ch]">Explore the analytics dashboard, sub-tabs configuration CRUD boards, and local mission lists.</p>
                                            </div>
                                            <button 
                                        ...
                                        <div className="p-5 bg-[#1C2026] border border-white/[0.04] rounded-xl flex items-center justify-between gap-4">
                                            <div className="space-y-1">
                                                ...
                                                <p className="text-body text-slate-400 max-w-[75ch]">Break down scenarios variables, tester personas, Gemini models, and criteria rules editor.</p>
                                            </div>
                                            <button 
